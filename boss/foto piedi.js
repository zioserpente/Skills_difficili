var pos=1
var intervallo
var vitabassi=parseInt(document.getElementById("punteggio").textContent)
var posbassi
var regen=0;
console.log("ciao"+vitabassi)
function KeyPress(event) {
    ...
    if(event.keyCode=32){
        if (pos==posbassi){
            vitabassi=vitabassi-1
            document.getElementById("punteggio").textContent=vitabassi
            if (vitabassi==0){
                clearInterval(intervallo)
                document.getElementById("punteggio").textContent="HAI VINTO"
                posbassi=50
            }
        }
    }
...
function generalibro(){
    ...
    posbassi=poslibro
    document.getElementById(poslibro+"11").style.backgroundImage="url('../textures!!1!1!!/bassi.png')";
    for (let i = 10; i >= 1; i--) {
        setTimeout(function() {
        ...
        if(i==1){
            if (pos==poslibro) {
                ...
                document.getElementById(poslibro+(""+i)).style.backgroundImage="url('../textures!!1!1!!/vuoto.png')"
                document.getElementById(poslibro+"11").style.backgroundImage="url('../textures!!1!1!!/vuoto.png')";
                console.log("skull")
                }}
        else{
            if(i==10){
                document.getElementById(poslibro+(""+i)).style.backgroundImage="url('../textures!!1!1!!/libro.png')"
                document.getElementById(poslibro+(""+(i+1))).style.backgroundImage="url('../textures!!1!1!!/bassi.png')"
            }
            else{
                document.getElementById(poslibro+(""+i)).style.backgroundImage="url('../textures!!1!1!!/libro.png')"
                document.getElementById(poslibro+(""+(i+1))).style.backgroundImage="url('../textures!!1!1!!/vuoto.png')"
